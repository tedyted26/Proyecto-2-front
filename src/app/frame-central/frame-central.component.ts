...
export class FrameCentralComponent implements OnInit {
  ...
  "Valores","Para nosotros siempre serán prioridad las personas. Para ello la inclusión social, el respeto al individuo, seguridad, comodidad, la facilidad de los trámites y la accesibilidad de nuestros servicios serán siempre un hecho para nuestros clientes."),
];
